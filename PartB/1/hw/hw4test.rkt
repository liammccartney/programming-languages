...
(define tests
  (test-suite
   ...
   ; list-nth-mod test
   (check-equal? (list-nth-mod null 2) "list-nth-mod: empty list"  "list-nth-mod null list")
   (check-equal? (list-nth-mod (list 1 2 3) 0) "list-nth-mod: negative number" "list-nth-mod negative number")
